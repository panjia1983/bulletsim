...
Eigen::MatrixXf calculateResponsibilities(const Eigen::MatrixXf& estPts, const Eigen::MatrixXf& obsPts, const Eigen::MatrixXf& stdev, const Eigen::VectorXf& pVis, const Eigen::VectorXf& outlierDist, const Eigen::VectorXf& outlierStdev) {
  std::ofstream estPts_file("estPts_online_E.txt");
  std::ofstream obsPts_file("obsPts_online_E.txt");
  std::ofstream stdev_file("stdev_online_E.txt");
  std::ofstream pVis_file("pVis_online_E.txt");
  std::ofstream outlierDist_file("outlierDist_online_E.txt");
  std::ofstream outlierStdev_file("outlierStdev_online_E.txt");
